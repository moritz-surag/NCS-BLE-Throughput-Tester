...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_MAX_CONN_EVENT_LEN_DEFAULT, 4000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_THROUGHPUT_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_THROUGHPUT_FILE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_THROUGHPUT_DURATION, 20000);
